 ...
 * #L%
 */
package de.fdamken.yalp.parsing.ast.representation.expression.function.math;
...
public class RemainderFunction extends AbstractFunction {
    private Expression valueA;
    private Expression valueB;
